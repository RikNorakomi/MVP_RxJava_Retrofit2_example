package norakomi.com.MVP_RxJava_Retrofit2.views;
...
/**
 * MVC view interface.
 * MVC view is a "dummy" component used for presenting information to the user.
...
public interface IViewMvc {
     ...
     * implementations of concrete MVC views.
